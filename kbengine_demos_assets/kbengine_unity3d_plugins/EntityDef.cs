...
namespace KBEngine
{
	...
	public class EntityDef
	{
		...
		public static void initScriptModules()
		{
			...
			EntityDef.idmoduledefs[8] = pTestEntityModule;
			...
			pTestEntity_onReqTestProperty_args.Add(EntityDef.id2datatypes[32]);
			...
			EntityDef.idmoduledefs[9] = pPlayerModule;
			...
			pPlayer_onUpdateBattle_args.Add(EntityDef.id2datatypes[38]);
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Player), method(onUpdateBattle / 42).");

			List<DATATYPE_BASE> pPlayer_onUpdateGridInfoList_args = new List<DATATYPE_BASE>();
			pPlayer_onUpdateGridInfoList_args.Add(EntityDef.id2datatypes[35]);
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Player), method(onUpdateGridInfoList / 43).");
		...
		public static void initDefTypes()
		{
...

			{
				...
				DATATYPE_AnonymousArray_40 datatype = new DATATYPE_AnonymousArray_40();
				EntityDef.datatypes[typeName] = datatype;
				EntityDef.id2datatypes[utype] = EntityDef.datatypes[typeName];
				EntityDef.datatype2id[typeName] = utype;
			}
			...
			{
				UInt16 utype = 41;
				string typeName = "AnonymousArray_41";
