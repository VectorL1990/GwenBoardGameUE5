...
void EntityDef::initScriptModules()
{
	...
	pAvatar_onSyncBattleResult->methodUtype = 26;
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onSyncBattleResult / 26).");
	...
	pAvatar_onSyncChangeHandCardSuccess->methodUtype = 17;
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onSyncChangeHandCardSuccess / 17).");
	...
	pAvatar_onSyncExhaustCardReplacement->methodUtype = 16;
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onSyncExhaustCardReplacement / 16).");
	...
	pAvatar_onSyncHeartBeat->methodUtype = 24;
	...
	pAvatar_onSyncLatestBattleState->methodUtype = 25;
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onSyncLatestBattleState / 25).");
	...
	pAvatar_onSyncLaunchSkillFailed->methodUtype = 14;
	...
	pAvatar_onSyncPlayerBattleInfo->methodUtype = 15;
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onSyncResumeBattle / 23).");
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onSyncSelectCardInterlude / 21).");
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onSyncUpdateActionInfo / 13).");
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onSyncUpdateSelectedCards / 18).");
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(reqLatestBattleInfo / 10).");
	...
	pAvatar_reqLaunchCardSkill->methodUtype = 12;
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(reqLaunchCardSkill / 12).");
	...
	pAvatar_reqPlayCardAction->methodUtype = 11;
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(reqPlayCardAction / 11).");
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(reqSyncHeartBeat / 9).");
