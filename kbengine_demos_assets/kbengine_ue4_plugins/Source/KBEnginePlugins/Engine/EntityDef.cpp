...
void EntityDef::initScriptModules()
{
	...
	Player_onUpdateBattle_args.Add(EntityDef::id2datatypes[38]);
	...
	Player_onUpdateGridInfoList_args.Add(EntityDef::id2datatypes[35]);

	Method* pPlayer_onUpdateGridInfoList = new Method();
	pPlayer_onUpdateGridInfoList->name = TEXT("onUpdateGridInfoList");
	pPlayer_onUpdateGridInfoList->methodUtype = 43;
	...
	//DEBUG_MSG("EntityDef::initScriptModules: add(Player), method(onUpdateGridInfoList / 43).");
...
void EntityDef::initDefTypes()
{
...

	{
		...
		DATATYPE_AnonymousArray_40* pDatatype = new DATATYPE_AnonymousArray_40();
		EntityDef::datatypes.Add(typeName, (DATATYPE_BASE*)pDatatype);
		EntityDef::id2datatypes.Add(utype, EntityDef::datatypes[typeName]);
		EntityDef::datatype2id.Add(typeName, utype);
	}
	...
	{
		uint16 utype = 41;
		FString typeName = TEXT("AnonymousArray_41");
	...
	{
		uint16 utype = 42;
		FString typeName = TEXT("AnonymousArray_42");
		FString name = TEXT("ENTITY_COMPONENT");
		DATATYPE_BASE** fPtr = EntityDef::datatypes.Find(name);
		DATATYPE_BASE* pVal = fPtr != NULL ? *fPtr : NULL;
		EntityDef::datatypes.Add(typeName, pVal);
	...
	{
		uint16 utype = 43;
		FString typeName = TEXT("AnonymousArray_43");
		FString name = TEXT("ENTITY_COMPONENT");
		DATATYPE_BASE** fPtr = EntityDef::datatypes.Find(name);
		DATATYPE_BASE* pVal = fPtr != NULL ? *fPtr : NULL;
		EntityDef::datatypes.Add(typeName, pVal);
