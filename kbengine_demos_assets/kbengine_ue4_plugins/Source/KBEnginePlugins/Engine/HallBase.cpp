...
void HallBase::onComponentsEnterworld()
{
}

void HallBase::onComponentsLeaveworld()
{
}
...
void HallBase::onGetBase()
{
	...
	pBaseEntityCall = new EntityBaseEntityCall_HallBase(id(), className());
}
...
void HallBase::onGetCell()
{
	...
	pCellEntityCall = new EntityCellEntityCall_HallBase(id(), className());
}
...
void HallBase::onRemoteMethodCall(MemoryStream& stream)
{
}

void HallBase::onUpdatePropertys(MemoryStream& stream)
{
	ScriptModule* sm = *EntityDef::moduledefs.Find("Hall");
...
void HallBase::attachComponents()
{
}

void HallBase::detachComponents()
{
}
